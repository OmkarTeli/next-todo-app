...
const CreateTask = () => {
   ...
   return (
      <div>
         <form className="relative w-96 mx-auto my-8 mb-5 bg-white p-4 rounded-md">
            <input
               name="title"
            ...
            <button
               ...
               className="bg-yellow-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-3"
            >
               Add
            </button>
         </form>
